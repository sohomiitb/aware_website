...
export const SparklesIcon = () => <AlertTriangle className="h-6 w-6 text-current text-red-600" />
...
export const ShieldIcon = () => <MessageSquare className="h-6 w-6 text-current text-indigo-600" />
