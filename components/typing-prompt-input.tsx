...
export default function TypingPromptInput() {
  const prompts = [
    "Should I adjust my meds before tomorrow's marathon?",
    "Explain today's visit and lab results with Dr. Mandal...",
    "Show me this weeks steps of my 4 week rehab plan...",
    "Today was my first run after my surgery, how can i decrease the pain?",
    "Why is my resting heart rate up this week?",
  ]
